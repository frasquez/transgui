...
Connecting to daemon=Connectando con el proceso en segndo plano Daemon
...
Donate via PayPal,WebMoney,Credit card=Donar via PayPal,WebMoney,Trajeta de Crédito
Done=Completado
...
seconds=segundos
Seed ratio=Proporción de entrega
...
Share ratio=Proporción en que compartes
...
Torrents=Torrents
Unable to execute "%s"=Imposible ejecutar "%s"
...
Seeding time=Tiempo compartiendo
...
Unable to find path mapping.~Use the application's options to setup path mappings=No se ha podido encontrar la ruta de mapeo. ~ Utilice las opciones de la aplicación para asignar la ruta de mapeo
